...
var DesignerPeer = /** @class */ (function (_super) {
    ...
    DesignerPeer.prototype.updateAriaProperties = function () {
...
var ActionPeer = /** @class */ (function (_super) {
    ...
    ActionPeer.prototype.populatePropertySheet = function (propertySheet, defaultCategory) {
        ...
        propertySheet.add(defaultCategory, ActionPeer.idProperty, ActionPeer.isEnabledProperty, ActionPeer.titleProperty, ActionPeer.tooltipProperty, ActionPeer.modeProperty, ActionPeer.styleProperty, ActionPeer.iconUrlProperty, ActionPeer.roleProperty);
    };
    ...
    ActionPeer.roleProperty = new EnumPropertyEditor(Adaptive.Versions.v1_6, "role", "Role", Adaptive.ActionRole);
    return ActionPeer;
}(DesignerPeer));
...
var CarouselPeer = /** @class */ (function (_super) {
    ...
    CarouselPeer.prototype.populatePropertySheet = function (propertySheet, defaultCategory) {
        ...
        propertySheet.add(defaultCategory, CarouselPeer.timerProperty, CarouselPeer.initialPageProperty, CarouselPeer.orientationProperty, CarouselPeer.heightInPixelsProperty, CarouselPeer.loopProperty);
    };
    ...
    CarouselPeer.orientationProperty = new EnumPropertyEditor(Adaptive.Versions.v1_6, "carouselOrientation", "Orientation", Adaptive.Orientation);
    CarouselPeer.heightInPixelsProperty = new NumberPropertyEditor(Adaptive.Versions.v1_6, "carouselHeight", "Height in pixels");
    CarouselPeer.loopProperty = new BooleanPropertyEditor(Adaptive.Versions.v1_6, "carouselLoop", "Loop");
    return CarouselPeer;
}(ContainerPeer));
