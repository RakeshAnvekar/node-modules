    ...
    CardDesigner.prototype.buildTreeView = function () {
        if (this._treeViewToolbox.content) {
            ...
            if (this.designerSurface.isPreviewMode) {
                ...
                treeView.onItemInvoked = function () {
                    var propertySheetHosts = document.getElementsByClassName("acd-propertySheet-host");
                    if (propertySheetHosts.length === 1) {
                        var propertySheetHost = propertySheetHosts[0];
                        // get focusable children
                        var focusableElements = propertySheetHost.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]');
    ...
    CardDesigner.prototype.attachTo = function (root) {
        ...
        if (this._copyJSONButton.isVisible) {
            new Clipboard(this._copyJSONButton.renderedElement, {
                ...
                .on("success", function () {
                _this._copyJSONButton.renderedElement.focus();
                _this.toolbar.addAlert("Card payload copied");
            });
        }
        // Tool palette panel
